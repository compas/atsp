...
*
     ...
     :       (QNOCORB,NOCORB(8,1)),(QJ1,J1QNRD(15,1))
      ...
      pointer(pind,ind(nterm)),(pnze_term,nze_term(nj)),
     :       (pnze_col,nze_col(nj)),(pnze_t,nze_t(1)),
     :       (pnze_c,nze_c(1))
      common/im_nze/pflsj,pnze_term,pnze_col,pind,nt,mxj,
     :              mnj,nj
      common/hmx_nze/pnze_t,pnze_c
      pointer(pflsj,flsj(nterm,nterm,2,mxj))
!      integer nze_term(nj),nze_col(nj),ind(nterm)
      integer nterm,mxj,mnj,nj 
