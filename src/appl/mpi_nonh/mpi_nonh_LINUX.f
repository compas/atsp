...
CPJ
      ...
      write(*,*) 'In mpi_nonh', tmpdir(1:lentmp),cwd(1:lcwd)
...
*    .. write block information to cfg.inp
      if(myid == 0) then
CPJ         write(25,'(3x,A3,I8,I8,i20)') term, ncfg, nij_tot
         write(25,'(3x,A3,I8,i20)') term, ncfg, nij_tot
      end if 
