...
*
C      print *, 'hii:', (hii(i),i=1,n)
C      print *, 'hmx:', (hmx(i),i=1,nze)
C      print *, 'jptr:', (jptr(i),i=1,n)
C      print *, 'imx:', (imx(i),i=1,nze)

C      write(*,*) iupper,nze,tmp,tp,Ncfg,lim,hii,ilowmihigh,iselect
C      write(*,*) niv,mblock,crite,critc,critr,ortho,maxiter,eigenvec
C      write(*,*) iworksz,iwork,iiwsz,hiend,nloops,nmv,ierr
